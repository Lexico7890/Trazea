...
import type { ActionType, InventoryEditSheetProps } from "../model/types";
import { useRequestsStore } from "@/features/spares-request-workshop";
import { updateItemComplete } from "@/entities/inventario";
...
export function InventoryEditSheet({ item, open, onOpenChange, onSaveSuccess }: InventoryEditSheetProps) {
    ...
    const { sessionData, checkMenuPermission } = useUserStore();
