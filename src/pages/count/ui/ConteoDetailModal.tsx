            ...
            <DialogContent className="sm:max-w-[800px] max-h-[85vh] p-0 overflow-hidden flex flex-col">
                {isLoading ? (
                    ...
                    <>
                        ...
                        <div
                            className={`p-6 h-56 relative overflow-hidden ${hasDifferences
                                ? 'bg-linear-to-br from-amber-500/20 to-red-500/20 border-b-4 border-amber-500'
                                : 'bg-linear-to-br from-emerald-500/20 to-green-500/20 border-b-4 border-emerald-500'
                                }`}
                        >
                        ...
                        <div className="p-6 space-y-4 overflow-y-auto flex-1">
                            ...
                            <div className="grid grid-cols-3 gap-3 pt-2">
                                <div className="bg-linear-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                                ...
                                <div className={`rounded-lg p-4 border ${hasDifferences
                                    ? 'bg-linear-to-br from-amber-50 to-amber-100 dark:from-amber-950 dark:to-amber-900 border-amber-200 dark:border-amber-800'
                                    : 'bg-linear-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900 border-emerald-200 dark:border-emerald-800'
                                    }`}>
                                    <div className="flex items-center gap-2 mb-2">
                                ...
                                <div className="bg-linear-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                                    <div className="flex items-center gap-2 mb-2">
